...
import cy.com.morefan.R.drawable;
...
import cy.com.morefan.frag.FragMark;
        ...
        Callback
{
    ...
    protected void onStart()
    {
        ...
        if (isLogin())
        {
            ...
            loginUser.setText(application.readUserName(MainActivity.this));
            residualFlow.setText(String.valueOf(application
                    .readUserBalance(MainActivity.this)) + "M");
            tips.setText("可兑换流量");
        } else
        {
            BitmapLoader
    ...
    protected void onResume()
    {
        ...
        if (isLogin())
        {
            ...
            Util.loginUI();
            BitmapLoader.create().displayUrl(MainActivity.this, headImage,
                    imageUrl, // "http://img4.imgtn.bdimg.com/it/u=3309848897,132969131&fm=21&gp=0.jpg",
                ...
                if (isLogin())
                {
                    ...
                    mHandler.post(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            // TODO Auto-generated method stub
                            // 获取最新的签到信息
                            int signStatus = application.readInt(
                                    MainActivity.this,
                                                            ...
                                                            .getToken()))
                                            {
                                                ...
                                                application
                                                        .writeUserInfoToLocal(
                                                                ...
                                                                DateUtils
                                                                        .formatDate(userData
                                                                                .getRegDate(), Constant.DATE_FORMAT),
                                                            ...
                                                            "签到成功，你已经领取了"
                                                                    + application
                                                                            .readString(
                                                                                    MainActivity.this,
                                                                                    Constant.LOGIN_USER_INFO,
                                                                                    Constant.LOGIN_USER_SIGN_TODAY)
                                                                    + "M流量。");
                            ...
                            } else if (1 == status)
                            {
                                ...
                                /*AlertDialog.Builder dialog = new AlertDialog.Builder(
                                        MainActivity.this);
                                dialog.setTitle("用户签到");
                                dialog.setMessage("你已经签到，已经领取了"
                                        + application.readString(
                                                MainActivity.this,
                                                Constant.LOGIN_USER_INFO,
                                                Constant.LOGIN_USER_SIGN_TODAY)
                                        + "M流量。跳转到签到中心确认。");
                                dialog.setPositiveButton("跳转",
                                        new DialogInterface.OnClickListener()
                                        {
                                                    ...
                                                    int which)
                                            {
                                                ...
                                                // 跳转到签到中心界面
                                                application.mFragManager
                                                        .setCurrentFrag(FragType.Mark);
                                                mHandler.sendEmptyMessage(DataListener.IS_MARK);
                                                layDrag.closeDrawer(Gravity.LEFT);

                                            }
                                        });
                                dialog.setNegativeButton("不跳转",
                                        new DialogInterface.OnClickListener()
                                        {
