...
public class WXPayUtil
{
     ...
     */
    public static final String APP_KEY ="NzfP6pfeljyHeY08LO9p8YAKZCGLz8akO4lCGdXZOGnVsJqfo8jeuYB7C0GoFJGEKZMDVGKWYnbbJj3pCpvJzd4iY7bVglaNz54XAD26tiCr5DZGLjZFoRxbqe8i3HT5"; //"L8LrMqqeGRxST5reouB0K66CaYAWpqhAVsq7ggKkxHCOastWksvuX1uvmvQclxaHoYd3ElNBrNO2DHnnzgfVG9Qs473M3DTOZug5er46FhuGofumV8H2FVR9qkjSlC5K"; // wxd930ea5d5a258f4f
                                                                                                                                                                              // 对应的支付密钥
    ...
    private static String AccessToken = "e_X1nINQ9X936ezlNs9VSI0jbfKxyCrnz67ZC1xK04fwLHEWR_kNNtMB6FqU-1-hkbzgHgHIqlUVMYRGX9gysRsHLCaItHtaGn8eBX1WeFk";
    ...
    private GetPrepayIdResult sendPrePayReq(String accessToken)
    {
        ...
        Log.d(TAG, " prePay content = " + content);
    ...
    private GetAccessTokenResult getAccessToken()
    {
        ...
        {            
            String url = String.format(
                    ...
                    tokenUrl, Constant.WX_APPID, Constant.WX_APPSECRET);
    ...
    {
        String userName = MyApplication.readUserName(context);
    ...
    private String genProductArgs()
    {
        ...
        try
        {
            json.put("appid", Constant.WX_APPID);
            // traceId
            ...
            List<NameValuePair> signParams = new LinkedList<NameValuePair>();
            signParams.add(new BasicNameValuePair("appid", Constant.WX_APPID));
            signParams.add(new BasicNameValuePair("appkey", APP_KEY));
