...
public class SendFlowActivity extends BaseActivity implements Callback,
	...
	private void accpetFlow() {
		if (TextUtils.isEmpty(flowText.getText())) {
			...
			dialog.setTitle("求流量");
			dialog.setMessage("我要求" + flowText.getText().toString() + "M流量。");
	...
	private void initView() {
		...
		BitmapLoader.create().displayUrl(SendFlowActivity.this, img, imageUrl,
				R.drawable.mrtou, R.drawable.mrtou);
		imgRight = (NetworkImageView) this.findViewById(R.id.imgRight);
		BitmapLoader.create().displayUrl(SendFlowActivity.this, imgRight,
				bundle.getString("fanmorePicUrl"), R.drawable.mrtou,
				R.drawable.mrtou);
