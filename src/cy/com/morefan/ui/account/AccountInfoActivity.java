...
public class AccountInfoActivity extends BaseActivity implements Callback,
	...
	private void initData() {
		account = new Account();
		account.setBrithday(MyApplication.readString(AccountInfoActivity.this,
				Constant.LOGIN_USER_INFO, Constant.LOGIN_USER_BRITHDAY));
		String faqsIndex = MyApplication.readString(AccountInfoActivity.this,
				Constant.LOGIN_USER_INFO, Constant.LOGIN_USER_FAVS);
		account.setLocation(MyApplication.readString(AccountInfoActivity.this,
				Constant.LOCATION_INFO, Constant.LOCATION_ADDRESS));
		account.setLogo(MyApplication.readString(AccountInfoActivity.this,
				Constant.LOGIN_USER_INFO, Constant.LOGIN_USER_LOGO));
		account.setName(MyApplication.readString(AccountInfoActivity.this,
				Constant.LOGIN_USER_INFO, Constant.LOGIN_USER_ACCOUNT));
		account.setRegTime(MyApplication.readString(AccountInfoActivity.this,
				Constant.LOGIN_USER_INFO, Constant.LOGIN_USER_REG_DATE));
		int sexI = MyApplication.readInt(AccountInfoActivity.this,
		...
		ArrayList<UserSelectData> incomeList = new ArrayList<UserSelectData>();
		...
		ArrayList<UserSelectData> indutryList = new ArrayList<UserSelectData>();
		...
		ArrayList<UserSelectData> favoriteList = new ArrayList<UserSelectData>();
		if (fars != null && fars.length > 0) {
		...
		int comingI = MyApplication.readInt(AccountInfoActivity.this,
				Constant.LOGIN_USER_INFO, Constant.LOGIN_USER_INCOMING);
		int jobI = MyApplication.readInt(AccountInfoActivity.this,
