...
public class RegisterActivity extends BaseActivity implements OnClickListener
{
    ...
    public void onClick(View v)
    {
         ...
         * ToastUtils.showLongToast(RegisterActivity.this, "粉猫_流量猫。"); } break;
         */
        case R.id.backImage:
        {
        ...
        case R.id.btnGet:
        {
            ...
            if (isWritePhone())
            {
                ...
                CountDownTimerButton countDownBtn = new CountDownTimerButton(btnGet,"%d秒重新发送","获取验证码",60000);
                countDownBtn.start();
    ...
    private void getCode()
    {
        ...
        try
        {
            ...
            new GetVCAsyncTask(RegisterActivity.this, Constant.GET_VD_TYPE_REG).execute(url);
    ...
    private void showUseItem()
    {
        ...
        //跳转到隐私说明界面
        ActivityUtils.getInstance().showActivity(RegisterActivity.this, RlueActivity.class);
    }
    ...
    class RegisterAsyncTask extends AsyncTask<UserData, Void, FMRegisterBean>
    {
        ...
        protected void onPostExecute(FMRegisterBean result)
        {
            ...
            if (1 == result.getResultCode())
            {
                ...
                {
                    application.writeTokenToLocal(RegisterActivity.this,
                            regUser.getToken(), Constant.TOKEN_ADD);
                    application.writeUserInfoToLocal(RegisterActivity.this,
                            regUser.getName(), regUser.getBalance(),
                            regUser.getPictureURL(), regUser.getSignInfo(),
                            regUser.getInvCode(), regUser.getSigntoday(),
                            DateUtils.formatDate(regUser.getBirthDate(), Constant.DATE_FORMAT), regUser.getMobile(),
                            regUser.getCareer(), regUser.getIncoming(),
                            regUser.getFavs(), regUser.getArea(),
                            DateUtils.formatDate(regUser.getRegDate(), Constant.DATE_FORMAT), regUser.getWelcomeTip(),
                            regUser.getInvalidCode(), regUser.getSex(), regUser.getRealName());
                }
            ...
            } else
            {
                ...
                // 弹出注册失败提示框
                noticeDialog = new NoticeDialog(RegisterActivity.this,
                        R.style.NoticeDialog, "注册结果", "注册失败",
                        new NoticeDialog.LeaveMyDialogListener()
                        {
