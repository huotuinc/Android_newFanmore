...
//		setChildPadding(rootView, config);
		//SystemBarConfig config = mTintManager.getConfig();
		...
		//view2.setPadding(0, 20, 0, config.getPixelInsetBottom());
	}


//	private void setChildPadding(ViewGroup rootView, SystemBarConfig config) {
//		for(int i = 0, length = rootView.getChildCount(); i < length; i++){
//				View item = rootView.getChildAt(i);
//				if(item instanceof ListView){
//					item.setPadding(0, config.getPixelInsetTop(true), 0, config.getPixelInsetBottom());
//				}
//		}
//
//	}
	...
	public boolean isLogin()
	{
	     ...
	     * 
	     */
	    String localToken = application.readLocalToken(BaseActivity.this);
