...
public class Constant {
	...
	//public static final String BASE_URL = "http://115.28.160.96:8080/fanmoreweb/app/";//基础URL
	public static final String BASE_ROOT_URL = "http://apitest.51flashmall.com:8080/fanmoreweb/";  
	//"http://192.168.1.100:8080/fanmoreweb/";//
	/**liuqucheng**/
	//public static final String BASE_ROOT_URL = "http://192.168.0.14:8080/fanmoreweb/";
	/***/
	public static final String BASE_URL = BASE_ROOT_URL + "app/";//基础URL
	//public static final String BASE_URL = "http://192.168.1.117:8080/fanmoreweb/app/";//基础URL
	//public static final String BASE_URL = "http://192.168.0.14:8080/app/";//基础URL
	public static final String REGISTRATION_INTERFACE = BASE_URL + "reg";//注册         ---POST
	public static final String GET_VD_INTERFACE = BASE_URL + "sendSMS";//获取验证码     --GET
	...
	public static final String FORGET_INTERFACE = BASE_URL + "forgetPassword";//忘记密码  --GET
	public static final String BINDING_INTEFACE = BASE_URL + "bindingmobile";//绑定手机     ---POST
	public static final String MODIFYPSW_INTEFACE = BASE_URL + "modifyPassword";//修改密码   -- POST
	public static final String TASK_DATA_INTEFACE = BASE_URL+"taskList"; //"http://192.168.0.25:8080/fanmore/app/taskList";// BASE_URL + "taskList";//获取任务列表   ---GET
	public static final String PREPARE_CHECKOUT = BASE_URL + "prepareCheckout";//准备兑现   ---GET
	public static final String CHECKOUT = BASE_URL + "checkout";//实现兑现   ---POST
	public static final String PREPARE_BUY = BASE_URL + "prepareBuy";//准备兑现   ---GET
	public static final String TASK_DETAIL_INTEFACE = BASE_URL +"taskDetail"; //"http://192.168.0.25:8080/fanmore/app/taskDetail";//任务明细 ---GET
	public static final String TASK_TURNED_NOTIFY= BASE_URL +"taskTurnedNotify";//转发任务以后的通知 ---GET
	//实现购买
	//签到
	public static final String SIGN_IN = BASE_URL + "signin";//    ---POST
	public static final String MESSAGE = BASE_URL + "messages";//    获取消息列表    ---GET
	public static final String DELETE_MESSAGE = BASE_URL + "deleteMessage";//    删除消息列表    ---POST
	public static final String UPDATE_PROFILE = BASE_URL + "updateProfile";//    修改资料    ---POST
	public static final String DETAILS = BASE_URL + "details";//    流量明细    ---GET
	public static final String PREVIEW_TASK_LIST = BASE_URL + "previewTaskList";//    今日预告    ---GET
	public static final String MASTER_SYSTEM = BASE_URL + "shituInfo";//    师徒系统    ---GET
	public static final String DISCIPLE_LIST = BASE_URL + "appsList";//    徒弟列表    ---GET
	public static final String ANSWER = BASE_URL + "answer";//    答题    ---GET
	public static final String FEEDBACK = BASE_URL + "feedback";//   意见回馈    ---POST 
	public static final String SENT_FLOW = BASE_URL + "sentFlow";//   获取通讯录信息    ---POST 
	public static final String SETUP_ALIAS = BASE_URL + "setupAlias";//   将极光的别名推送给服务端    ---POST 
	//获取验证码类型
    ...
    public final static String TOKEN_CLEAR = "clear";//添加token
