...
public class AlarmReceiver extends BroadcastReceiver
{
    ...
    {        
        ...
        if (Constant.ALARM_ACTION.equals(action))
        {
            ...
            Intent noticeI = new Intent(context, PushMsgHandlerActivity.class);     
            noticeI.putExtra("type", Constant.MESSAGE_TYPE_TASK);
            
            noticeI.addFlags( Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            PendingIntent noticePI = PendingIntent.getActivity(context, taskid , noticeI, PendingIntent.FLAG_UPDATE_CURRENT );//获得PendingIntent
            ...
            Intent freshIntent = new Intent(MyBroadcastReceiver.REFRESH_TASK_STATUS);
