...
public class FragPre extends BaseFragment implements DataListener, Callback
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            String str = application.readString(getActivity(), Constant.TASK_ALARM_INFO, Constant.TASK_ALARM_INFO_ID);
    ...
    private void registerFreshReceiver()
    {
        ...
        filter.addAction(REFRESH_TASK_STATUS);
    ...
    public class PreTaskAdapter extends BaseAdapter
    {
                ...
                ViewGroup parent)
        {
            ...
            if (datas.size() > 0)
            {
                ...
                holder.pretips.setText("免费领取" + datas.get(position) ==null? "0" : datas.get(position).getReward()
                        + "M");
                    ...
                    holder.alarmBtn1.setOnClickListener(new OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            ...
                            if (tag)
                            {
                                ...
                                PendingIntent alarmPI = PendingIntent
                                        .getBroadcast(
                                                getActivity(),
                                                0,
                                                alarmI,
                                ...
                                alarmDialog = new AlarmDailog(getActivity(),
                                        "设置成功");
                                alarmDialog.show();
                            } else
                            {
                                // 取消闹钟
                                //alarm.cancel(null);
                                application.taskList.remove(taskData.getTaskId());
                            }
            ...
            AsyncTask<String, Void, FMPreTaskData>
    {
        ...
        @Override
        protected void onPostExecute(FMPreTaskData result)
        {
            // TODO Auto-generated method stub
            ...
            {
                for (TaskData taskData : initData())
                {
    ...
    private List<TaskData> initData()
    {
        ...
        item.setTitle("粉猫答题01粉猫答题粉猫答题粉猫答题");
        Date td = new Date(2015, 7, 3);
        item.setTimeToStart(234);
        item.setContextURL("http://www.baidu.com");
        item.setPublishDate(td.getTime());
        item.setPictureURL("http://hottech.gitcafe.io/resources/fanmoreicon/images/mrtou_b.png");
        item.setType(Constant.TASK_TYPE_ANSWER);
        item.setTaskId(0);
        item.setStatus("0");
        item.setPublishDate(System.currentTimeMillis());
        item.setDesc("粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享粉猫答题获流量分享");
        datas.add(item);
        item = new TaskData();
        item.setContextURL("http://www.cnblogs.com");
        item.setTitle("粉猫答题02");
        item.setTimeToStart(33333);
        item.setPictureURL("http://hottech.gitcafe.io/resources/fanmoreicon/images/mrtou_b.png");
        item.setType(Constant.TASK_TYPE_SIGN_UP);
        item.setTaskId(1);
        item.setStatus("2");
        item.setPublishDate(System.currentTimeMillis());
        item.setDesc("粉猫报名获流量分享");
        datas.add(item);
        item = new TaskData();
        item.setContextURL("http://www.sina.com.cn");
        item.setTimeToStart(4444);
        item.setTitle("粉猫答题03");
        item.setPictureURL("http://hottech.gitcafe.io/resources/fanmoreicon/images/mrtou_b.png");
        item.setType(Constant.TASK_TYPE_ANSWER_OUT);
        item.setTaskId(2);
        item.setStatus("1");
        item.setPublishDate(System.currentTimeMillis());
        item.setDesc("粉猫外链/画册类获流量分享");
        datas.add(item);
        item = new TaskData();
        item = new TaskData();
        item.setTitle("粉猫答题04");
        item.setTimeToStart(333333);
        item.setContextURL("http://www.bing.com");
        item.setPictureURL("http://hottech.gitcafe.io/resources/fanmoreicon/images/mrtou_b.png");
        item.setType(Constant.TASK_TYPE_PLAY);
        item.setTaskId(3);
        item.setStatus("3");
        item.setPublishDate(System.currentTimeMillis());
        item.setDesc("粉猫游戏类获流量分享");
        datas.add(item);
        item = new TaskData();
        item.setTitle("粉猫答题05");
        item.setPictureURL("http://hottech.gitcafe.io/resources/fanmoreicon/images/mrtou_b.png");
        item.setType(Constant.TASK_TYPE_ANSWER);
        item.setTaskId(0);
        item.setStatus("0");
        ...
        datas.add(item);
        item = new TaskData();
        item.setTitle("粉猫答题06");
        item.setTimeToStart(332334);
        item.setPictureURL("http://hottech.gitcafe.io/resources/fanmoreicon/images/mrtou_b.png");
        item.setType(Constant.TASK_TYPE_ANSWER);
        item.setTaskId(0);
        item.setStatus("0");
    ...
    public class RefreshReceiver extends BroadcastReceiver
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            if (REFRESH_TASK_STATUS.equals(intent.getAction()))
            {
                // 刷新列表项
                // 预告任务下标
