        ...
        OnClickListener
{
    ...
    private void checkMarkStatus()
    {
        ...
        // //binary to int
        int signStatus = application.readInt(getActivity(),
    ...
    private void refreshView()
    {
        ...
        btnMark.setText(0 == curMarkData.status ? "今日签到可获取"
                + application.readString(getActivity(),
                        Constant.LOGIN_USER_INFO,
                        Constant.LOGIN_USER_SIGN_TODAY) + "M流量" : "今日已签到");
    }
    ...
    public class CheckInAsyncTask extends AsyncTask<Void, Void, FMCheckIn>
    {
        ...
        protected void onPostExecute(FMCheckIn result)
        {
            ...
            if (1 == result.getResultCode())
            {
                ...
                {
                    // 刷新token
                    application.writeTokenToLocal(getActivity(), result
                            .getResultData().getUser().getToken(),
                            Constant.TOKEN_ADD);
                    // 保存用户信息
                    application.writeUserInfoToLocal(getActivity(), userData
                            ...
                            .formatDate(userData.getBirthDate(), Constant.DATE_FORMAT),
                ...
                refreshView();
                // 刷新界面
                MainActivity.residualFlow.setText(String.valueOf(application
                        .readUserBalance(getActivity())) + "M");
                // 提示签到成功，获取多少流量
                ToastUtils
                        .showLongToast(
                                getActivity(),
