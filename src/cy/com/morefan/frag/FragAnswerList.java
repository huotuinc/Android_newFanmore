...
//            if (((Answers) btnA.getTag()).getAid().toString().equals(correctId))
//            {
//                imgA.setBackgroundResource(R.drawable.anim_right);
//                AnimationDrawable animRight = (AnimationDrawable) imgA
//                        .getBackground();
//                animRight.start();
//                imgA.setVisibility(View.VISIBLE);
//                // llA.setBackgroundResource(R.drawable.yes);
//                // imgA.setVisibility(View.VISIBLE);
//                // imgA.setGifImage(R.drawable.dui);
//            } else if (((Answers) btnB.getTag()).getAid().toString().equals(correctId))
//            {
//                imgB.setBackgroundResource(R.drawable.anim_right);
//                AnimationDrawable animRight = (AnimationDrawable) imgB
//                        .getBackground();
//                animRight.start();
//                imgB.setVisibility(View.VISIBLE);
//                // llB.setBackgroundResource(R.drawable.yes);
//                // imgB.setVisibility(View.VISIBLE);
//                // imgB.setGifImage(R.drawable.dui);
//            } else if (((Answers) btnC.getTag()).getAid().toString().equals(correctId))
//            {
//                // llC.setBackgroundResource(R.drawable.yes);
//                // imgC.setVisibility(View.VISIBLE);
//                // imgC.setGifImage(R.drawable.dui);
//                imgC.setBackgroundResource(R.drawable.anim_right);
//                AnimationDrawable animRight = (AnimationDrawable) imgC
//                        .getBackground();
//                animRight.start();
//                imgC.setVisibility(View.VISIBLE);
//            } else if (((Answers) btnD.getTag()).getAid().toString().equals(correctId))
...
//                // imgD.setVisibility(View.VISIBLE);
//                // imgD.setGifImage(R.drawable.dui);
//                imgD.setBackgroundResource(R.drawable.anim_right);
//                AnimationDrawable animRight = (AnimationDrawable) imgD
//                        .getBackground();
//                animRight.start();
//                imgD.setVisibility(View.VISIBLE);
//            }
