...
public class FraDisciplesContribution extends Fragment
{
    ...
    public FraDisciplesContribution(TextView listNotice)
    {
    ...
    {
        // TODO Auto-generated method stub
        View parent = inflater.inflate(R.layout.dsisciples_contribution_ui, container, false);
        list = (KJListView) parent.findViewById(R.id.dsisciplesContribution);
        ...
        new GetDiscipleAsyncTask(Constant.REFRESH, getActivity(), adapter, datas, listNotice).execute(1);
        return parent;
    }
    ...
    private void initList()
    {
        list.setOnRefreshListener(new KJRefreshListener()
        {
            ...
            public void onLoadMore()
            {
                // TODO Auto-generated method stub
                list.setRefreshTime(DateUtils.formatDate(System.currentTimeMillis()), getActivity());
                new GetDiscipleAsyncTask(Constant.LOAD_MORE, getActivity(), adapter, datas, listNotice).execute(1);
                list.stopRefreshData();
            }
        });
    }
