...
public class FraDisciplesContribution extends Fragment
{
            ...
            Bundle savedInstanceState)
    {
        ...
        new GetDiscipleAsyncTask(Constant.REFRESH, getActivity(), adapter, datas).execute(1);
        return parent;
    }
    ...
    private void initList()
    {
        list.setOnRefreshListener(new KJRefreshListener()
        {
            ...
            public void onLoadMore()
            {
                // TODO Auto-generated method stub
                list.setRefreshTime(DateUtils.formatDate(System.currentTimeMillis()), getActivity());
                new GetDiscipleAsyncTask(Constant.LOAD_MORE, getActivity(), adapter, datas).execute(1);
                list.stopRefreshData();
            }
        });
    }
