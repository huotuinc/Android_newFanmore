...
import cy.com.morefan.view.KJListViewFooter.LoadMoreState;
import cy.com.morefan.view.KJListViewHeader.RefreshState;
...
public class KJListView extends ListView implements OnScrollListener {
     ...
     * @param time
     */
    public void setRefreshTime(String time, Context context) {
        mHeaderTimeView.setText("上一次刷新时间："+time);
        Resources res = context.getResources();
        mHeaderTimeView.setTextColor(res.getColor(R.color.gray_94));
    }
